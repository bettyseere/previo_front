...
export default function CompanyRecordsRaw({raw_data, action_btn}: Props) {
    ...
    return (
        raw_data && <div>
            <div>
                {dataToRender.length > 0 && <Table data={dataToRender} columns={table_columns} searchMsg="Search team records" actionBtn={action_btn} searchMode="double" /> }
            </div>
        </div>
    );
}
