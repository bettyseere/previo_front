    ...
    return (
        <div>
            ...
            {athletes_to_select.length > 0 && <div className="grid grid-cols-1 gap-4 items-center mt-2 w-[22rem]">
                ...
                <div onClick={()=>handleHidePopup({show: true, type: "create", data: {roles: roles, access_types: access_types, action: "invite_member"}})} className="flex items-center gap-2 hover:text-green-500 text-black/50 cursor-pointer">
                    <CiCircleInfo size={25} className="font-semibold" />
                    <p className="font-semibold">Send invite if Athlete doesn't exist</p>
                </div>
