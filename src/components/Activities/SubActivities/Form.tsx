...
import { create_sub_activity, update_sub_activity } from "../../../api/activities/sub_activities/sub_activities";
...
export default function ActivityForm({activity_id}: activities) {
    ...
    const handleDelete = (index: number) => {
        // Remove the item from the finished_translations list
        const new_translations = finished_translations.filter((_, i) => index !== i)
